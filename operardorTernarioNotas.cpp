...
int main(){
    ...
    ((average<scoreLimit && compliancePercentage>=assistanceLimit)? cout<<"Puedes Aplicar Recuperacion " : ((average<scoreLimit && compliancePercentage<assistanceLimit) ? cout<<"No calificas para recuperacion: ": cout<<"No calificas para recuperacion: "));
}
